      ...
      {!settings && <div className="home-page">
        <div className="home">
          ...
          <div style={{backgroundColor: `${timerColor}`}} className="timers">
            <button id={`standard-${timerSelected}`} onClick={() => {
              setTimerSelected('1');
        ...
        <div className="settings">
          ...
          <div className="break-types">
            ...
            <div className="standard">
              ...
              <input style={{backgroundColor: `${inputColor}`}} value={standard > 60 ? 60 : standard < 1 ? 1 : standard} type="number" onChange={(e) => {
          ...
          <div className="color-container">
            ...
            <div className="colors">
              <div style={{backgroundColor: 'rgb(232, 208, 255)'}} className="color-1" onClick={() => {
